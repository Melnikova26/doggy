...
<li>
  <span>Справа от формы показано число. Реализован счетчик, который крутится от 0 до указанного в скрипте числа 200.</span>
  <span>Счетчик начинает крутиться только когда до него докрутили, а не при загрузке страницы:</span>
